...
public:
    ...
    */
    ...
    /*!
        DeferHelper function to enable support for common swap implementation pattern based on \c std::swap:
        \code
...
private:
    ...
    void ClearStack() {
        if(Allocator::kNeedFree)
            while(stack_.GetSize() > 0) // Here assumes all elements in stack array are GenericValue (Member is actually
...
//! DeferHelper class for accessing Value of array type.
/*!
...
//! DeferHelper class for accessing Value of object type.
/*!
