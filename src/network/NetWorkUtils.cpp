...
//     }
// }
// native_socket_t MakeTcpV4Socket() { return MakeSocket(AF_FAMILY::INET, AF_PROTOL::TCP); }
// native_socket_t MakeUdpV4Socket() { return MakeSocket(AF_FAMILY::INET, AF_PROTOL::UDP); }
//
...
//     }
//
//     std::cout << "MakeBindedSocket : " << bind_sock << " Bind [" << ip << ":" << port << "] failed " <<
//     strerror(errno)
//               << std::endl;
//     ::close(bind_sock);
//     return -1;
...
//     socklen_t       len = 0;
//     sockaddr_in6    temp;
//     native_socket_t clientsock = ::accept(socket, (sockaddr *)&temp, &len);
//     if(clientsock < 0) {
//         return -1;
//     }
//     // clang-format off
...
//     socklen_t       len = 0;
//     sockaddr_in6    temp;
//     native_socket_t clientsock = ::accept4(socket, (sockaddr *)&temp, &len, flags);
//     if(clientsock < 0) {
//         return -1;
//     }
//     // clang-format off
...
//
//
// native_socket_t ConnectToHost(const ENDPOINTINFO &info, AF_PROTOL protol) {
